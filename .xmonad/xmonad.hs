...
myNormColor :: String
myNormColor   = "#012C9E"   --"#1877a2"  -- "#282c34"   -- Border color of normal windows

myFocusColor :: String
myFocusColor  = "#019E8E" --"#d92626" -- Border color of focused windows
...
myStartupHook = do
    ...
    spawnOnce "blueberry"
    spawnOnce "caffeine"
    spawnOnce "xss-lock -- xsecurelock"
...
myKeys =
	...
	, ("M-y", spawn $ "$HOME/.xmonad/scripts/charaters.sh")
	, ("M-e", spawn $ "thunar")
	, ("M-i", spawn $ "firefox")
	, ("M-s", spawn $ "yakuake")
	...
	, ("M-S-t", spawn "$HOME/.xmonad/scripts/picom-toggle.sh")
	...
	, ("<XF86_PowerOff>", spawn "xsecurelock")
